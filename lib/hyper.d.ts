...
export type ITermGroupReducer = Reducer<ITermState, webtermActions>;

export type IUiReducer = Reducer<uiState, webtermActions>;

export type ISessionReducer = Reducer<sessionState, webtermActions>;

import {Middleware, Reducer} from 'redux';
export type webtermPlugin = {
  getTabProps: any;
  getTabsProps: any;
  getTermGroupProps: any;
  getTermProps: any;
  mapHeaderDispatch: any;
  mapwebtermDispatch: any;
  mapwebtermTermDispatch: any;
  mapNotificationsDispatch: any;
  mapTermsDispatch: any;
  mapHeaderState: any;
  mapwebtermState: any;
  mapwebtermTermState: any;
...
export type webtermDispatch = ReturnType<typeof configureStore>['dispatch'];
...
import {webtermConnectedProps} from './containers/hyper';
export type webtermProps = webtermConnectedProps & extensionProps;
