...
import {webtermState, webtermDispatch, TermGroupProps, TermGroupOwnProps} from '../hyper';
...
const mapStateToProps = (state: webtermState, ownProps: TermGroupOwnProps) => ({
  childGroups: ownProps.termGroup.children.map((uid) => state.termGroups.termGroups[uid])
});

const mapDispatchToProps = (dispatch: webtermDispatch, ownProps: TermGroupOwnProps) => ({
